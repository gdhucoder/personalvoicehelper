...
from voice_assistant.tasks.image_understand_task import ImageUnderstandTask
...
class AssistantController:
    ...
    def _handle_command(self, text: str):
        ...
        elif intent == "image_understand":
            # 将 WeatherTask 加入调度器
            self.scheduler.enqueue(
                ImageUnderstandTask(prompt=text, ws_client=self.ws)
            )
